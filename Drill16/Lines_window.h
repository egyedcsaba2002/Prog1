...
private:
	...
	void change(Color c) {lines.set_color(c); style_button.move(0, -50); style_menu.move(0, -50);}
	void menu_pressed() { menu_button.hide(); color_menu.show(); style_button.move(0, 50); style_menu.move(0, 50);}
	void color_pressed()
	{
		menu_button.hide();
		color_menu.show();
